...
var translationsInEnglish = {
    ...
    'load_questions': 'Load questions from markdown',
    'upload_questions': 'Upload questions from Excel',
    ...
    // menu sections
    'about_app': 'About',
    'upload_file': 'Use file with questions',
    'retrieve_file': 'Retrieve questions from internet',
    ...
    'upload_desc': 'Use this option to load questions from your computer or mobile. File content must be in special ${format} to be parsed with application. Another option allows to use ${template} with own questions in Excel speadsheet.',
